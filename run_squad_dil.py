...
#from squad2 import squad_convert_examples_to_features
...
from modeling_auto_dil import AutoModelForQuestionAnswering
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.save_steps > 0 and global_step % args.save_steps == 0:
                    ...
                    config_to_update["non_interaction_layers"] = args.non_interaction_layers
...
def main():
    ...
    parser.add_argument(
        "--non_interaction_layers",
        default=10,
        type=int,
        required=True,
        help="The number of non interaction layers for dilbert or dilalbert",
    )
    parser.add_argument(
        "--output_dir",
        default=None,
    ...
    parser.add_argument(
        ...
        type=str, 
        default="linear", 
        help="The way the learning rate decrements. Schedule in ['constant', 'cosine', 'cosine_hard_restarts', 'linear']."
        "See details at https://huggingface.co/transformers/main_classes/optimizer_schedules.html",)
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        with open(os.path.join(args.output_dir, "config.json")) as json_file:
            config_to_update = json.load(json_file)
        
        #adding number of non interaction layers to config
        config_to_update["non_interaction_layers"] = args.non_interaction_layers
            
        with open(os.path.join(args.output_dir, "config.json"), 'w') as json_file:
            json.dump(config_to_update, json_file)
